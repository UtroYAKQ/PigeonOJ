"""管理 / 运维域控制器：系统配置 / 日志 / 沙箱状态 / 举报处理与数据访问仓储。

用户管理逻辑在 controllers.user（admin 路由调用）。
（模型配置服务随 AI 模块暂缓实现）
...
from app.controllers.system_config import ConfigRepository
from app.controllers.user import UserRepository
from app.controllers.audit import LogRepository
