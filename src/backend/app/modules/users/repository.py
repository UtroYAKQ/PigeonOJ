"""用户模块数据访问（Repository 层：只做 SQLAlchemy 封装，不做业务判断）。

数据所有权（docs/architecture.md）：用户数据查询必须带 user_id 约束。
"""
...
from app.modules.users.models import Role, User, UserRole, UserSession
